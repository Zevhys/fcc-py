...
## Table of Contents
These projects are designed to test and let you apply the Python concepts you've learned throughout the course, such as:
...
## Getting Started
# Clone Repository
git clone https://github.com/Zevhys/fcc-py .
